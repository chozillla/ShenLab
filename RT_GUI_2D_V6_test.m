...
global openmha a gt Glast D x2max d D_vals
...
%     Hmatch = findobj(handles.hfig);
    ...
    if B == 0
        ...
        formatOut = 31;
        d = datestr(now, formatOut);
        baseFileName = sprintf('%s,gaintable.mat', d);  
        save(baseFileName,'gt');
