function sim_res_err = simulation_v3(n_init_trials,G0,sigma0)
...
for itrial = 1:Ntrials
      ...
      % divide the procedure into the Initiation part,Frequency Band by Band part, and 
      ...
      elseif itrial > n_init_trials
        ...
        Ent = zeros(1,n_candidates);                       % expected entropy
         ...
         parfor icandidate = 1:n_candidates        % for each a_candidate
      ...
      elseif itrial >= n_init_trials
        % band by band
        % estimate a gaussian distribution from the previously collected data points
        a_candidate = zeros(6,n_candidates);
