...
% G(1) = x1 + a(1)*x2+g_last;   %This is what G equation looks like
% G(2) = x1 + a(2)*x2 ;
% G(3) = x1 + a(3)*x2;
% G(4) = x1 + a(4)*x2;
% G(5) = x1 + a(5)*x2;
...
%G0 = intial will be 0 but each time a new value for each iteration 

G = G0 + x1 + diag(a)*[x2;x2;x2;x2;x2;x2];
