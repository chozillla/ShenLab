...
if  stateII == 1
    ...
    writematrix('Change Time','DataLog.xlsx','Range','B3');
    writematrix('Channel 2','DataLog.xlsx','Range','C3');
    writematrix('Change Time','DataLog.xlsx','Range','D3');
    writematrix('Channel 3','DataLog.xlsx','Range','E3');
    writematrix('Change Time','DataLog.xlsx','Range','F3');
    writematrix('Channel 4','DataLog.xlsx','Range','G3');
    writematrix('Change Time','DataLog.xlsx','Range','H3');
    writematrix('Channel 5','DataLog.xlsx','Range','I3');
    writematrix('Change Time','DataLog.xlsx','Range','J3');
    writematrix('Channel 6','DataLog.xlsx','Range','K3');
    writematrix('Change Time','DataLog.xlsx','Range','L3');
